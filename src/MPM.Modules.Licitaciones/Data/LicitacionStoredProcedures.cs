...
public static class LicitacionStoredProcedures
{
    ...
    public const string BuscarNatural = "SELECT * FROM usp_Licitaciones_BuscarNatural(@p_query, @p_page, @p_page_size, @p_estado, @p_fecha_desde)";
    public const string BuscarNaturalCount = "SELECT * FROM usp_Licitaciones_BuscarNatural_Count(@p_query, @p_estado, @p_fecha_desde)";
