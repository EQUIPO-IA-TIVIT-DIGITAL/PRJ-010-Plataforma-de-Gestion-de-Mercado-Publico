-- V151: 0+1+2 capacitacion 14-08-2026 - Filtro por monto minimo/maximo en listado principal
-- Cesar 03:03: ocultar licitaciones por debajo de umbral (ej 50M). Complementa filtro ya existente
-- en Alertas (V079) y BuscarNatural (V107) pero faltaba en Listar paginado.
-- Se agrega p_monto_desde / p_monto_hasta y condiciones sobre l.monto_estimado.
