...
description: Usa esta skill para diseñar la operación y evolución del framework. Sirve
  para definir monitoreo, soporte, incidentes, SLOs, versionado, deprecación, backward
  compatibility, gestión de cambios y ciclo de mejora continua.
metadata:
  when_to_use:
