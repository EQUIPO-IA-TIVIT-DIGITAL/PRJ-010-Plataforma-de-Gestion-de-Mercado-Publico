...
- CEN-R008: las certificaciones del an�lisis se tratan como requisitos (mandatorias) y las tecnolog�as como skills buscados; no hay ranking diferenciado mandatorias/deseables � l�mite documentado (backlog).
- CensusClient.DownloadCertificationFileAsync es adelanto de Fase 3 (no expuesto por endpoint).
- El GET de decisi�n devuelve 
