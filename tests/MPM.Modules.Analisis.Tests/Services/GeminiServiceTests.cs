...
public class GeminiServiceTests
{
    ...
    public async Task AnalyzePdfAsync_ReturnsParsedText()
    {
        ...
        var service = new GeminiService(httpClient, BuildConfig(), FakeTokenProvider(), NullLogger<GeminiService>.Instance);
    ...
    public async Task AnalyzePdfAsync_HandlesEmptyCandidates()
    {
        ...
        var result = await service.AnalyzePdfAsync(new byte[] { 1, 2, 3 }, "x.pdf", gcsUri: null);
